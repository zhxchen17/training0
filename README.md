...
### 一条cmd命令的基本格式<a id="sec-2-1-2" name="sec-2-1-2"></a>
...
### `dir` 命令<a id="sec-2-1-3" name="sec-2-1-3"></a>
...
### `cd` 命令<a id="sec-2-1-4" name="sec-2-1-4"></a>
...
### `echo` 命令<a id="sec-2-1-5" name="sec-2-1-5"></a>
