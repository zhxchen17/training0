...
关于通配符的使用，[[http://zh.wikipedia.org/zh-cn/%E9%80%9A%E9%85%8D%E7%AC%A6][可以参考wikipedia-通配符]]。
...
+ [[http://cli.learncodethehardway.org/book/][Command Line Crash-一个命令行快速教程]]
+ [[http://www.cs.princeton.edu/courses/archive/spr05/cos126/cmd-prompt.html][Windows Command Prompt in 15 Minutes]]
+ [[http://linuxcommand.org/learning_the_shell.php][Learning the linux shell]]
